...
module.exports = (client, oldMessage, newMessage) => {
  ...
  if (oldMessage.content != newMessage.content) {
    ...
    if (
      ...
      embed
        .setTitle('Aktualizowanie wiadomości: `Edycja`')
        .setDescription(`
          ${newMessage.member} **wiadomość** na ${newMessage.channel} Została edytowana. [Zobacz wiadomość!](${newMessage.url})
        `)
        .addField('Przed', oldMessage.content)
        .addField('Po', newMessage.content);
